    ...
    try:
        ...
        for r in reviews:
            result_list.append({
                ...
                'sentiment': r[2],
                """
                r[3] — IsNegative в ответе не указываем, оно больше будет полезно при разрастании базы, или анализе техподдержкой, когда
                нужно анализировать только негатив, просто сам поиск будет быстрее проходить чем по STRING объектам в SQL базе. 
                """
                'created_at': r[4]
            })
